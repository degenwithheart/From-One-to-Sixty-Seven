---
name: security
description: Security-hardened rules for systems where failure means breach or harm. Activated when working with auth, crypto, input validation, or sensitive data.
---

# Security-Hardened Engineering Rules
